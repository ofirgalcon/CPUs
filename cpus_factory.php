...
$factory->define(Cpus_model::class, function (Faker\Generator $faker) {
    ...
    return [
        ...
        'perflevel0_physicalcpu' => $faker->randomNumber($nbDigits = 2, $strict = false),
        ...
        'perflevel1_physicalcpu' => $faker->randomNumber($nbDigits = 2, $strict = false),
        ...
        'perflevel0_cpusperl2' => $faker->randomNumber($nbDigits = 1, $strict = false),
        'perflevel1_cpusperl2' => $faker->randomNumber($nbDigits = 1, $strict = false),
    ];
});
